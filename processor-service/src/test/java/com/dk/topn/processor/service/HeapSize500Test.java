...
public class HeapSize500Test {
    ...
    public void validateHeapSize(){
        heapProcessorService.process(sampleData(1000, 0));
            List<ScoreDto> heap = heapProcessorService.getCurrentData();
            Assertions.assertEquals(500, heap.size());
    }
    ...
    public void validateMaxHeap(){
        heapProcessorService.process(sampleData(1000, 500));
        List<ScoreDto> heap = heapProcessorService.getCurrentData();
